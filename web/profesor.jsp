<%-- 
    Document   : profesor
    Created on : 22.09.2020., 14.56.49
    Author     : Cvele
--%>
    ...
    %>
        <%
            try {
                ...
                String sql =  "SELECT p.*,casovi_vreme FROM predmet p INNER JOIN casovi c ON c.predmet_id = p.predmet_id";
        ...
        <tbody>
            <tr>
                <td><%=resultSet.getString("predmet_id")%></td>
